...
[[nodiscard]] static inline mk_view_wstr_t condition_entry_to_wstr_note(FWPM_FILTER0 const* const filter, FWPM_FILTER_CONDITION0 const* const condition)
{
	...
	wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_empty));
	if(false){}
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==   1)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_icmpv4)     ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==   2)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_igmp)       ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==   6)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_tcp)        ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  17)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_udp)        ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  41)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_ipv6generic)); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  43)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_ipv6route)  ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  44)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_ipv6frag)   ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  47)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_gre)        ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  58)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_icmpv6)     ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  59)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_ipv6nonxt)  ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 ==  60)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_ipv6opts)   ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 == 112)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_vrrp)       ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 == 113)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_pgm)        ); }
	else if((guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_PROTOCOL])) && (condition->conditionValue.type == FWP_UINT8) && (condition->conditionValue.uint8 == 115)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_protocol_l2tp)       ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V4    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_packet_too_big         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_packet_too_big)         ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_packet_too_big         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_packet_too_big)         ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V4  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_packet_too_big         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_packet_too_big)         ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_packet_too_big         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_packet_too_big)         ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V4    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_redirect               )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_redirect)               ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_redirect               )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_redirect)               ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V4  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_redirect               )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_redirect)               ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_redirect               )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_redirect)               ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V4    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_echo_request           )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)           ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_echo_request           )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)           ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V4  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_echo_request           )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)           ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_echo_request           )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)           ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V4    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_router_advertisement   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_advertisement)   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_router_advertisement   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_advertisement)   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V4  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_router_advertisement   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_advertisement)   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_router_advertisement   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_advertisement)   ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V4    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_time_exceeded          )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)          ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_time_exceeded          )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)          ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V4  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_time_exceeded          )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)          ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_time_exceeded          )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)          ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V4    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_timestamp_request      )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_timestamp_request)      ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_timestamp_request      )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_timestamp_request)      ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V4  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_timestamp_request      )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_timestamp_request)      ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_timestamp_request      )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_timestamp_request)      ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V4    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_address_mask_request   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_address_mask_request)   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_address_mask_request   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_address_mask_request)   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V4  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_address_mask_request   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_address_mask_request)   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V4 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v4_e_address_mask_request   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_address_mask_request)   ); }

	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_destination_unreachable         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_destination_unreachable)         ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_destination_unreachable         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_destination_unreachable)         ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_destination_unreachable         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_destination_unreachable)         ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_destination_unreachable         )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_destination_unreachable)         ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_time_exceeded                   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)                   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_time_exceeded                   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)                   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_time_exceeded                   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)                   ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_time_exceeded                   )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_time_exceeded)                   ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_echo_request                    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)                    ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_echo_request                    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)                    ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_echo_request                    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)                    ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_echo_request                    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_echo_request)                    ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_query        )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_query)        ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_query        )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_query)        ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_query        )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_query)        ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_query        )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_query)        ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report       )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report)       ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report       )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report)       ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report       )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report)       ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report       )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report)       ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_router_solicitation             )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_solicitation)             ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_router_solicitation             )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_solicitation)             ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_router_solicitation             )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_solicitation)             ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_router_solicitation             )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_router_solicitation)             ); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_solicitation )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_solicitation) ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_solicitation )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_solicitation) ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_solicitation )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_solicitation) ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_solicitation )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_solicitation) ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_advertisement)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_advertisement)); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_advertisement)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_advertisement)); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_advertisement)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_advertisement)); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_neighbor_discovery_advertisement)){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_neighbor_discovery_advertisement)); }
	...
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_CONNECT_V6    ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report_v2    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report_v2)    ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_ORIGINAL_ICMP_TYPE])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report_v2    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report_v2)    ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_INBOUND_ICMP_ERROR_V6  ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report_v2    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report_v2)    ); }
	else if((guid_eq(&filter->layerKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6 ])) && (guid_eq(&condition->fieldKey, &k_konst.m_guids.m_guids.m_guids[guid_id_e_FWPM_CONDITION_IP_LOCAL_PORT     ])) && (condition->matchType == FWP_MATCH_EQUAL) && (condition->conditionValue.type == FWP_UINT16) && (condition->conditionValue.uint16 == mk_net_icmp_v6_e_multicast_listener_report_v2    )){ wstr = nstr_to_wstr(k_strings.get_nstr(k_strings.string_id::id_icmp_multicast_listener_report_v2)    ); }
